...
if ( ! function_exists( 'jigsaw_storage_get' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_get( $var_name, $default = '' ) {
		global $JIGSAW_STORAGE;
		return isset( $JIGSAW_STORAGE[ $var_name ] ) ? $JIGSAW_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'jigsaw_storage_set' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_set( $var_name, $value ) {
		global $JIGSAW_STORAGE;
		$JIGSAW_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'jigsaw_storage_empty' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $JIGSAW_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $JIGSAW_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $JIGSAW_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $JIGSAW_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_isset' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $JIGSAW_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $JIGSAW_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $JIGSAW_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $JIGSAW_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_unset' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $JIGSAW_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			unset( $JIGSAW_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			unset( $JIGSAW_STORAGE[ $var_name ][ $key ] );
		} else {
			unset( $JIGSAW_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_inc' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_inc( $var_name, $value = 1 ) {
		global $JIGSAW_STORAGE;
		if ( empty( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = 0;
		}
		$JIGSAW_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'jigsaw_storage_concat' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_concat( $var_name, $value ) {
		global $JIGSAW_STORAGE;
		if ( empty( $JIGSAW_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'jigsaw_storage_get_array' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $JIGSAW_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $JIGSAW_STORAGE[ $var_name ][ $key ] ) ? $JIGSAW_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $JIGSAW_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $JIGSAW_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_set_array' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_set_array( $var_name, $key, $value ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$JIGSAW_STORAGE[ $var_name ][] = $value;
		} else {
...
if ( ! function_exists( 'jigsaw_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function jigsaw_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ][ $key ] ) ) {
			$JIGSAW_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( '' === $key2 ) {
			$JIGSAW_STORAGE[ $var_name ][ $key ][] = $value;
		} else {
			$JIGSAW_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_merge_array( $var_name, $key, $value ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$JIGSAW_STORAGE[ $var_name ] = array_merge( $JIGSAW_STORAGE[ $var_name ], $value );
		} else {
			$JIGSAW_STORAGE[ $var_name ][ $key ] = array_merge( $JIGSAW_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			jigsaw_array_insert_after( $JIGSAW_STORAGE[ $var_name ], $after, $key );
		} else {
			jigsaw_array_insert_after( $JIGSAW_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function jigsaw_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			jigsaw_array_insert_before( $JIGSAW_STORAGE[ $var_name ], $before, $key );
		} else {
			jigsaw_array_insert_before( $JIGSAW_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_push_array' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_push_array( $var_name, $key, $value ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $JIGSAW_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $JIGSAW_STORAGE[ $var_name ][ $key ] ) ) {
				$JIGSAW_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $JIGSAW_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $JIGSAW_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $JIGSAW_STORAGE[ $var_name ] ) && is_array( $JIGSAW_STORAGE[ $var_name ] ) && count( $JIGSAW_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $JIGSAW_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $JIGSAW_STORAGE[ $var_name ][ $key ] ) && is_array( $JIGSAW_STORAGE[ $var_name ][ $key ] ) && count( $JIGSAW_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $JIGSAW_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'jigsaw_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function jigsaw_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( empty( $JIGSAW_STORAGE[ $var_name ][ $key ] ) ) {
			$JIGSAW_STORAGE[ $var_name ][ $key ] = 0;
		}
		$JIGSAW_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'jigsaw_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function jigsaw_storage_concat_array( $var_name, $key, $value ) {
		global $JIGSAW_STORAGE;
		if ( ! isset( $JIGSAW_STORAGE[ $var_name ] ) ) {
			$JIGSAW_STORAGE[ $var_name ] = array();
		}
		if ( empty( $JIGSAW_STORAGE[ $var_name ][ $key ] ) ) {
			$JIGSAW_STORAGE[ $var_name ][ $key ] = '';
		}
		$JIGSAW_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'jigsaw_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $JIGSAW_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $JIGSAW_STORAGE[ $var_name ] ) ? $JIGSAW_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $JIGSAW_STORAGE[ $var_name ] ) ? $JIGSAW_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'jigsaw_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function jigsaw_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $JIGSAW_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $JIGSAW_STORAGE[ $var_name ]->$prop ) ? $JIGSAW_STORAGE[ $var_name ]->$prop : $default;
	}
}
