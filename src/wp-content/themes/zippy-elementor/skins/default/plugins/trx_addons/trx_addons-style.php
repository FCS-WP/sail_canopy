...
if ( ! function_exists( 'jigsaw_trx_addons_get_css' ) ) {
	add_filter( 'jigsaw_filter_get_css', 'jigsaw_trx_addons_get_css', 10, 2 );
	function jigsaw_trx_addons_get_css( $css, $args ) {
