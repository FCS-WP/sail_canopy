...
if ( ! function_exists( 'jigsaw_woocommerce_get_css' ) ) {
	add_filter( 'jigsaw_filter_get_css', 'jigsaw_woocommerce_get_css', 10, 2 );
	function jigsaw_woocommerce_get_css( $css, $args ) {
...
$fdir = jigsaw_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
