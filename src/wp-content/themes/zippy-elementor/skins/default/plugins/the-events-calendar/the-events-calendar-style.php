...
if ( ! function_exists( 'jigsaw_tribe_events_get_css' ) ) {
	add_filter( 'jigsaw_filter_get_css', 'jigsaw_tribe_events_get_css', 10, 2 );
	function jigsaw_tribe_events_get_css( $css, $args ) {
