...
WordPress version: required at least 5.0, tested up to 6.4.2
...
Please install and activate it before starting to use the theme Jigsaw.
...
Theme documentation is available on https://jigsaw.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Jigsaw is Fontello.
